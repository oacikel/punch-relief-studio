  ...
  return (
    <section className="stage-panel" aria-labelledby="orient-heading">
      ...
      <p className="helper-text">
        ...
        surface visible from this single viewpoint becomes the pattern -- occluded and back
        surfaces are not captured, so undercuts and hidden detail will not appear in the result.
        This is a front-view bas-relief interpretation, not a full 3D reconstruction.
      </p>
      {children}
    </section>
  );
